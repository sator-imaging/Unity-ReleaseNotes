...
*   Profiler: fixed unable to control to which PC the Player connects when using 'Autoconnect Profiler ([1141872](https://issuetracker.unity3d.com/issues/player-profiler-profiler-keeps-connecting-to-the-same-player-even-if-its-not-restarted))
    
*   Profiler: fixed unable to control to which PC the Player connects when using 'Autoconnect Profiler (1149416)
    
*   Profiler: fixed unable to control to which PC the Player connects when using 'Autoconnect Profiler ([1182142](https://issuetracker.unity3d.com/issues/unable-to-control-to-which-pc-the-player-connects-when-using-autoconnect-profiler))
...
*   Scripting: Fixed a case where changing a SerializedReference value would cause fields not to be found ([1205258](https://issuetracker.unity3d.com/issues/range-attribute-in-a-nested-class-breaks-serialization-functionality-when-used-in-a-custom-editor))
...
*   Video: Fix for movies with multiple video tracks on Windows ([1196384](https://issuetracker.unity3d.com/issues/crash-on-windowsvideomedia-getnextvideoframegeneric-when-importing-3d-mp4-video))
    
*   Video: Fix VideoPlayer memory leaks in Play mode ([1168659](https://issuetracker.unity3d.com/issues/videoplayer-leaks-memory-when-in-play-mode))
