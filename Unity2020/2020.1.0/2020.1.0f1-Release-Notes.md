...
*   Graphics: Metal: Fixed HLSL compatibility with DrawProceduralIndirect, SV\_InstanceID always starts at 0 but with Metal, a base instance was not subtracted for equal behavior
...
*   Asset Import: Added: Added _IgnorePNGGamma_ getter and setter to `TextureImporter`.
...
*   Asset Import: Added the _IgnorePNGGamma_ setting to the Texture Importer. (1172234)
...
*   Package Manager: Prevented switching to the _All Packages_ mode ehen selecting a UPM Asset Store package in _My Assets_.
...
*   Editor: Support to switch between debug and release code optimizations without restarting the Unity Editor improving Unity Editor performance when compiling in release.  
    ![description](/sites/default/files/debug-mode-810x4552x_0.jpg)
...
*   GI: Add Russian roulette for CPU lightmapper. Add setter in UI to select at which bounce the russian roulette starts.  
    ![description](/sites/default/files/lightmapping-optimizations-810x4552x.jpg)
...
*   GI: Added support for baking light cookies to the progressive lightmapper backends.  
    ![description](/sites/default/files/lightmap-cookie-support-8_12-810x4552x.jpg)
...
*   Package Manager: Moved the _Reset Packages_ option to the bottom of the _Advanced_ menu in Package Manager window, and added a separator between it and the preceding options.
...
*   Shaders: New shader preprocessor (experimental).  
    ...
    *   The new preprocessor is not yet used for Compute or Raytracing shaders.  
        ![description](/sites/default/files/shaderpreprocess.png)
...
*   UI Elements: Added a new HelpBox element.  
    ![description](/sites/default/files/yb4alps.gif)
