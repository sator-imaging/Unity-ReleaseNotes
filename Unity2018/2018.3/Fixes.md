...
*   Scripting: Fixed a problem with **Scripting Runtime Version** not updating when modifying the _ProjectSettings.asset_ file from an external tool such as version control, overwriting the file, etc. ([1010811](https://issuetracker.unity3d.com/issues/regression-scripting-runtime-version-didnt-change-from-outside-cause-crash-on-2018-dot-1))
...
*   Shaders: Fixed bad Metal shader code generation on some cases using SV\_GroupIndex. (1097866)
...
*   UI: Fixed crash at CanvasRenderer\_CUSTOM\_SplitUIVertexStreamsInternal when using VertexHelper. (943157)
