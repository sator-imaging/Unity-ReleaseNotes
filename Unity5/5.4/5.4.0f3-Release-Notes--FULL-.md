...
*   [\[797902\]](https://issuetracker.unity3d.com/issues/letterbox-fills-with-artifacts-from-steam-overlay-in-fullscreen-mode) UI: Black bars that are only visible when game and display resolution aspect ratios don't match are now cleared every frame.
...
*   [\[780185\]](https://issuetracker.unity3d.com/issues/editor-rendertexture-flickering-ui-and-randomly-changing-sprites-when-enabling-slash-disabling-image-in-a-camera-space) UI: Fixed buffers not being copied to threads causing the incorrect shader properties to be used and UI flickering to occur.
...
*   [\[772003\]](https://issuetracker.unity3d.com/issues/cursor-locked-cursor-is-not-centered-on-the-y-axis-cursor-dot-lockstate-equals-cursorlockmode-dot-locked) UI: Fixed inadvertent interaction with UI when cursor is locked.
...
*   [\[780112\]](https://issuetracker.unity3d.com/issues/2drectmask-after-changing-state-of-2drectmask-scene-has-to-be-reloaded-for-changes-to-take-an-effect) UI: Fixed nested RectMask2D not updating when enabling/disabling them.
...
*   [\[807558\]](https://issuetracker.unity3d.com/issues/vr-billboard-particles-in-right-eye-dont-change-position-after-initialization) VR: Fixed Particle System rendering in stereoscopic rendering modes.
...
*   [\[784933\]](https://issuetracker.unity3d.com/issues/framerate-is-not-capped-while-running-in-background) Windows: Windowed Direct3D 11 applications will no longer run with their framerate uncapped when minimized.
...
*   [\[801951\]](https://issuetracker.unity3d.com/issues/splash-image-custom-splash-image-does-not-appear-in-windows-build-when-the-projects-name-includes-specific-characters) Windows Standalone: Custom images will now be shown correctly in the screen selector dialog when building to a directory with non-Western/Latin alphanumeric characters.
...
*   [\[793456\]](https://issuetracker.unity3d.com/issues/reference-rewriter-fails-to-rewrite-winmds-from-windows-8-windows-dot-winmd-to-windows-10-contracts) Windows Store: Fixed a crash that could occur when building a UWP app that references Windows.winmd from a non-standard location.
...
*   [\[730023\]](https://issuetracker.unity3d.com/issues/uwp-wsa-xbox-one-controller-recognized-as-xbox-360) Windows Store: Unity will no longer report XboxOne controllers as Xbox 360 controllers.
