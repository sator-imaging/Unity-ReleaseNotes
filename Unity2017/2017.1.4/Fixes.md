...
<li>Graphics: Fixed changing the projectors render queue in script not having an effect. (933548)</li>
...
<li>Mobile: Fixed black screen on devices that do not support RGBA16F rendering to texture. (989654)</li>
